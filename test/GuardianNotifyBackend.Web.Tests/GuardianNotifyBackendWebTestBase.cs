...
{
    public abstract class GuardianNotifyBackendWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static GuardianNotifyBackendWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(GuardianNotifyBackendWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<GuardianNotifyBackendDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<GuardianNotifyBackendDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<GuardianNotifyBackendDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<GuardianNotifyBackendDbContext, Task<T>> func)
        {
            T result;
