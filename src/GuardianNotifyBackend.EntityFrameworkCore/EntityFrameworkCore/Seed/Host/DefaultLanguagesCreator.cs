...
namespace GuardianNotifyBackend.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = GuardianNotifyBackendConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(GuardianNotifyBackendDbContext context)
        {
            _context = context;
        }
